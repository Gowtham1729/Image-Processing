...
HD_PWD='C:/Users/Gowtham/Desktop/DS_project/Blurring/Blurring.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blur.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blur.tcl
