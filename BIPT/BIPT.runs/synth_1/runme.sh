...
HD_PWD='C:/Users/Gowtham/Desktop/DS_project/BIPT/BIPT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Modules.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Modules.tcl
