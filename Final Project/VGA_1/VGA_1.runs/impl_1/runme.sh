...
HD_PWD='C:/Users/Gowtham/Desktop/Final Project/VGA_1/VGA_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_syncIndex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_syncIndex.tcl -notrace
