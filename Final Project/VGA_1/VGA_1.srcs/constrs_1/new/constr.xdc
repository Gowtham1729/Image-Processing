...
set_property IOSTANDARD LVCMOS33 [get_ports {sel_module[2]}]


set_property PACKAGE_PIN W15 [get_ports {sel_module[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sel_module[3]}]
...
#set_property PACKAGE_PIN U19 [get_ports {sel_module[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {sel_module[0]}]
#set_property PACKAGE_PIN V19 [get_ports {sel_module[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {sel_module[1]}]
#set_property PACKAGE_PIN W18 [get_ports sel_module[2]]
#set_property IOSTANDARD LVCMOS33 [get_ports sel_module[2]]
#set_property PACKAGE_PIN U15 [get_ports {sel_module[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {sel_module[3]}]
##set_property PACKAGE_PIN U14 [get_ports {led[6]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {led[6]}]
#set_property PACKAGE_PIN V14 [get_ports {val[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {val[0]}]
#set_property PACKAGE_PIN V13 [get_ports {val[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {val[1]}]
#set_property PACKAGE_PIN V3 [get_ports {val[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {val[2]}]
#set_property PACKAGE_PIN W3 [get_ports {val[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {val[3]}]
#set_property PACKAGE_PIN U3 [get_ports {val[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {val[4]}]
#set_property PACKAGE_PIN P3 [get_ports {val[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {val[5]}]
#set_property PACKAGE_PIN N3 [get_ports {val[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {val[6]}]
#set_property PACKAGE_PIN P1 [get_ports {val[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {val[7]}]
##set_property PACKAGE_PIN L1 [get_ports {val[0]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {val[0]}]
